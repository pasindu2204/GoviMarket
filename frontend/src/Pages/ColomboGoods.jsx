...
const pageContent = {
  ...
  Si: {
    badge: 'කොළඹ නිෂ්පාදන ',
    title: 'කොළඹ භාණ්ඩ',
    subtitle: 'කොළඹ සහ ආසන්න මධ්‍යස්ථානවලින් සෘජුවම නගර මුළුතැන්ගෙවල්, කඩ, සදහා වේගවත් බෙදාහැරීම.',
    heroNote: 'ලැයිස්තුව තුළ Colombo ලෙස සලකුණු කර ඇති නිෂ්පාදන මෙහි පෙන්වයි.',
    stats: [
      { value: 'නගර මිශ්‍රණය', label: 'කොළඹ සහ ආසන්න වෙළඳපොළවල්' },
      { value: 'වේගවත් බෙදාහැරීම', label: 'නගර ගැනුම්කරුවන් සඳහා' },
      { value: 'තොග තත්ත්වය', label: 'නිෂ්පාදන වලින් සෘජුවම' },
    ],
    sectionTitle: 'කොළඹ ප්‍රදේශයේ නිෂ්පාදන',
    sectionText: 'කොළඹ ස්ථානවලින් ලැබෙන නිෂ්පාදන ලැයිස්තුව.',
    loading: 'කොළඹ භාණ්ඩ පූරණය වෙමින්...',
    error: 'කොළඹ භාණ්ඩ පූරණය කළ නොහැක. backend port 5000 මත ක්‍රියාත්මක වන බව තහවුරු කරන්න.',
    empty: ' කොළඹ භාණ්ඩ හමු නොවිණි.',
