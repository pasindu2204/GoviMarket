...
function OurOffer() {
  ...
  const content = {
    ...
    Si: {
      ...
      offers: [
        {
          title: 'දූපත පුරා නොමිලේ බෙදාහැරීම',
          description: 'රු. 2,000 ඉක්මවන ඇණවුම් සඳහා දූපත පුරා නොමිලේ බෙදාහැරීම. නැත්නම් රු. 250.',
          highlight: 'නොමිලේ / රු. 250',
          icon: 'TRUCK',
        },
        {
        ...
        {
          title: 'දින 7කින් නැවත ලබාදීම',
          description: 'ගුණාත්මක ගැටළු සඳහා දින 7ක් ඇතුළත මුදල් ආපසු. ප්‍රශ්න නැත.',
